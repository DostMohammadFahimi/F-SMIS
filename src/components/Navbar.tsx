    ...
    <div className="flex items-center justify-between p-4">
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        ...
        <div className="flex items-center justify-center bg-white rounded-full w-7 h-7 cursor-pointer relative">
          ...
          <div className="absolute -top-3 -right-3 w-5 h-5 flex items-center justify-center bg-cyan-500 text-purple-700 rounded-full text-xs">
            2
          </div>
        </div>
        <div className="flex flex-col">
          <span className="text-sm leading-3 font-medium ">Ali</span>
